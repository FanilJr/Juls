...
class LocalChatTableViewCell: UITableViewCell {
    ...
    func constraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            nameCommentUser.trailingAnchor.constraint(equalTo: profileImageView.leadingAnchor,constant: -10),
            
            timeAgo.trailingAnchor.constraint(equalTo: nameCommentUser.leadingAnchor,constant: -5),
            ...
            descriptionNameandText.trailingAnchor.constraint(equalTo: profileImageView.leadingAnchor,constant: -10),
